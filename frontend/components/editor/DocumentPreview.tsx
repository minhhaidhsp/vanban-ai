...
export function DocumentPreview({ data, onClose }: DocumentPreviewProps) {
  ...
  const template    = isBlank ? getTemplateForType("QĐ") : getTemplateForType(data.loaiVanBan);
  ...
  // Blank / upload mode — chỉ render noiDung, không NĐ30 header/footer
  if (isBlank) {
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto bg-[#e5e7eb] py-6 print:bg-white print:p-0 print:overflow-visible">
          <div
            className="blank-content mx-auto bg-white shadow-lg print:shadow-none"
            style={{
              width: "210mm",
              minHeight: "297mm",
              padding: "20mm 25mm",
